--1. El listado de empleados que han fungido como gerentes de turno de la sede donde más socios se han inscrito.
...
--3. El detalle del empleado de atención al cliente que más veces se ha reubicado entre sedes.
...
--5. El detalle de los 5 ejercicios que más veces aparecen en los entrenamientos.
...
--7. El listado de cuántas máquinas hay en cada sede por músculo principal.
...
--9. El número de socios activos por membresía que hay en cada sede.
...
--10. Idetificar el mes en que más socios terminan su contrato.
...
--11. El promedio de duración de los entrenamientos asignados por sede.
...
--12. Los detalles de la sede que ha impartido más clase grupales pero tiene menos duchas.
...
--13. La información de los socios con membresías plus que más sedes visitaron el último mes 
...
--14. El detalle de los entrenadores que están de turno en la hora en que más socios llegan a entrenar por sede.
...
--15. El detalle de la sede donde más socios han terminado su contrato.
...
--16. El listado de usuarios que tienen asignado el entrenamiento con mayor número de ejercicios.
...
--17. El detalle de la sede con más personal de recepción pero menos número de lockers.
...
--18. El número de clases que se han impartido de cada disciplina, en cada sede.
...
--19. El entrenador que más socios atiende por turno (matutina, mixto, vespertina, nocturno) por sede.
...
--20. La máquina por sede que ha tenido más mantenimientos durante todo su tiempo de uso.
